...
// source: belshare/eav/merchant.proto
...
func (*Merchant) Descriptor() ([]byte, []int) {
	return fileDescriptor_c3fc44648ad8f369, []int{0}
}
...
func (m *Merchant) GetGuid() string {
	if m != nil {
		return m.Guid
	}
	return ""
...
func init() {
	proto.RegisterType((*Merchant)(nil), "belshare.eav.Merchant")
}

func init() { proto.RegisterFile("belshare/eav/merchant.proto", fileDescriptor_c3fc44648ad8f369) }

var fileDescriptor_c3fc44648ad8f369 = []byte{
	...
	,
}
...
func (m *Merchant) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Guid) > 0 {
		i -= len(m.Guid)
		copy(dAtA[i:], m.Guid)
		i = encodeVarintMerchant(dAtA, i, uint64(len(m.Guid)))
		i--
		dAtA[i] = 0xa
	}
